...
def create_dinov3_only_model(input_shape, num_classes=1, dinov3_model='facebook/dinov3-vitb16-pretrain-lvd1689m'):
    """
    Ablation: DINOv3-only baseline (no CNN branch)
    Processes RGB through DINOv3 only
    """
    print("\n" + "="*70)
    print("CREATING DINOV3-ONLY MODEL (Ablation Baseline)")
    print("="*70)
    print(f"Input shape: {input_shape}")
    print(f"DINOv3 model: {dinov3_model}")
    print("Components: DINOv3 only (no CNN branch)")
    print("="*70)
...
def create_hybrid_concat_model(input_shape, num_classes=1, dinov3_model='facebook/dinov3-vitb16-pretrain-lvd1689m'):
    """
...
def run_full_ablation_study(
    ...
    # ========================================================================
    # EXPERIMENT 5: Hybrid with Small DINOv3
    # ========================================================================
    ...
    if skip_existing and exp_path.exists():
        ...
        print("\n" + "="*70)
        print("EXPERIMENT 5: HYBRID WITH SMALL DINOV3")
        print("="*70)
        
        model = create_hybrid_full_model(
            input_shape=(img_size[0], img_size[1], 10),
            num_classes=1,
            dinov3_model='facebook/dinov3-vits14-pretrain-lvd1689m',
            dinov3_size='small'
        )
